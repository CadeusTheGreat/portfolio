...
class TimelinePageCompact extends StatefulWidget {
  const TimelinePageCompact({super.key});

  @override
  State<TimelinePageCompact> createState() => TimelinePageState();
}

class TimelinePageState extends State<TimelinePageCompact> {
  @override
